...
public class DatabaseHelper extends SQLiteOpenHelper implements Database {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        Log.d("CREATE DATABASE", "Create " + DatabaseContents.TABLE_PICTURES + " Successfully.");

        db.execSQL("CREATE TABLE " + DatabaseContents.TABLE_GROUPS + "("
        ...
        Log.d("CREATE DATABASE", "Create " + DatabaseContents.TABLE_GROUPS + " Successfully.");
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + DatabaseContents.TABLE_GROUPS);
